...
class KTX2Parser {
    ...
    static async transcodeAsync(arrayBuffer) {
        ...
        const response = await worker.transcodeAsync(new Uint8Array(arrayBuffer), KTX2Parser.defaultRGBAFormat.basisFormat, KTX2Parser.defaultRGBFormat.basisFormat);
    ...
    static TranscoderWorker = TranscoderWorkerKTX2_1.TranscoderWorkerKTX2;
