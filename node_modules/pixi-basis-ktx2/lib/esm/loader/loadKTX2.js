...
exports.loadKTX2 = {
    ...
    async load(url, asset, loader) {
        await TranscoderWorkerKTX2_1.TranscoderWorkerKTX2.onTranscoderInitialized;
        // get an array buffer...
        const response = await core_1.settings.ADAPTER.fetch(url);
        const arrayBuffer = await response.arrayBuffer();
        const resources = await KTX2Parser_1.KTX2Parser.transcode(arrayBuffer);
...
async function loadKTX2BufferToTexture(byteArr, fileName, loader) {
    await TranscoderWorkerKTX2_1.TranscoderWorkerKTX2.onTranscoderInitialized;
    const resources = await KTX2Parser_1.KTX2Parser.transcode(byteArr.buffer);
    const type = resources?.basisFormat ? Basis_1.BASIS_FORMAT_TO_TYPE[resources?.basisFormat] : undefined;
    const format = resources?.basisFormat !== Basis_1.BASIS_FORMATS.cTFRGBA32 ? core_1.FORMATS.RGB : core_1.FORMATS.RGBA;
...
async function loadKTX2BufferToArray(byteArr, fileName, loader) {
    await TranscoderWorkerKTX2_1.TranscoderWorkerKTX2.onTranscoderInitialized;
    const resources = await KTX2Parser_1.KTX2Parser.transcode(byteArr.buffer);
    const type = resources?.basisFormat ? Basis_1.BASIS_FORMAT_TO_TYPE[resources?.basisFormat] : undefined;
    const format = resources?.basisFormat !== Basis_1.BASIS_FORMATS.cTFRGBA32 ? core_1.FORMATS.RGB : core_1.FORMATS.RGBA;
