...
const TranscoderWorkerWrapperBasis_1 = require("./TranscoderWorkerWrapperBasis");
/**
...
class TranscoderWorkerBasis {
    ...
    static loadTranscoder(jsURL, wasmURL) {
        const jsPromise = fetch(jsURL)
            .then((res) => res.text())
            .then((text) => {
            TranscoderWorkerBasis.jsSource = text;
        });
        const wasmPromise = fetch(wasmURL)
            .then((res) => res.arrayBuffer())
            .then((arrayBuffer) => {
            TranscoderWorkerBasis.wasmSource = arrayBuffer;
        });
...
//# sourceMappingURL=TranscoderWorkerBasis.js.map